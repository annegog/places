...
export default function ProfilePage() {
  ...
  const [changeToHost, setChangeToHost] = useState(false);
  const [changeToTenant, setChangeToTenant] = useState(false);
  ...
  const handleUpgrade = (ev) => {
    ...
    switch (optionValue) {
      case "host":
        setChangeToHost(isChecked);
        break;
      case "tenant":
        setChangeToTenant(isChecked);
        break;
      default:
        break;
    }
        ...
        <div >
          <div className="grid gap-4 mb-2 md:grid-cols-1 mt-6 mb-6">
            ...
            <div>
              ...
              <div className="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " >
                {host && tenant ? "host, tenant" : host? "host": tenant? "tenant":""} 
              </div>
            </div>
      ...
      {edit && (
        <div>
          <form onSubmit={updateUser}>
            <div className="grid gap-4 mb-2 md:grid-cols-1 mt-6">
              ...
              <div>
                {!tenant && (
                  <div className="text-center">
                    ...
                    type="checkbox"
                    value="tenant"
                    checked={changeToTenant}
                    onChange={handleUpgrade}
                    />
                    <span className="ml-2">Upgrade to Tenant</span>
                  </div>
                )}
                {!host && (
                  <div className="text-center">
                    ...
                    type="checkbox"
                    value="host"
                    checked={changeToHost}
                    onChange={handleUpgrade}
                    />
                    <span className="ml-2">Upgrade to Host</span>
                  </div>
                )}
              </div>
            </div>
